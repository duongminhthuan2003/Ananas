    ...
    return (
        <div>
            ...
            <div className="mx-8 md:mx-auto md:my-12 md:w-10/12 lg:w-8/12 mt-8 flex flex-row items-center">
                <p className="text-xl font-BeVietnamBold">YÊU THÍCH</p>
            ...
            <div className="flex font-BeVietnamRegular justify-center items-center text-sm flex-col md:flex-row mx-6 md:mx-auto md:w-10/12 lg:w-8/12 my-6">
